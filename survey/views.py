...
from models import Survey, SurveyAnswer, QuestionAnswer, Choice, Question #these are the models being brought to the controller.
...
def choice_add(request):
  question = Question.objects.get(id=int(request.session['current_question']))
  newChoice = Choice()
  newChoice.choice = request.POST['choice_text']
